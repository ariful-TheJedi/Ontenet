...
const Certificate = () => {
  ...
  useEffect(() => {
    document.querySelector(".certificate-awards-section").style.background = `url(${url}/wp-content/uploads/2025/10/IMG_7702_2.jpg) no-repeat center center/cover`;
  }, [url]);
    ...
    <div className="certificate-container">
      ...
      <section className="certificate-awards-section">
        ...
        <div className="certificate-timeline">
          <div className="certificate-timeline-item featured">
