...
import PhoneAlliance from "../assets/phone-alliance.png";
import PhonePopular from "../assets/phone-popular.png";
// import './Contact.css';
          ...
          <p>Scan the QR code to save our contact information directly to your phone</p>
            ...
            <div className="contact-qr-container">
              <div  className="contact-qr-code">
                <img src={PhoneAlliance} alt={`QR Code for dr Razzak Alliance Hospital Limited `} />
                <p>Save Shymoli Contact</p>
              </div>

              <div  className="contact-qr-code">
                <img src={PhonePopular} alt={`QR Code for dr Razzak popular diagnostic center Limited`} />
