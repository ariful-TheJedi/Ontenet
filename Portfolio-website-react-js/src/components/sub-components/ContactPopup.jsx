...
const ContactPopup = ({ isOpen, onClose }) => {
  ...
  const contactInfo = {
    ...
    address: "Popular Diagnostic Center Limited, Dhanmondi, Dhaka, Building-6, Floor-5th, Room-508, Dhaka, Bangladesh",
    whatsapp: "+88 01604707090",
    twitter: "https://x.com/abdurrazzak103",
    facebook: "https://www.facebook.com/nephrology.bd/",
    linkedin: "https://www.linkedin.com/in/muhammad-abdur-razzak-mbbs-md-fasn-60a594128/",
  ...
  return (
    <div className="contact-popup-overlay" onClick={onClose}>
      ...
      >
        ...
        <center><a className="contact-popup-button" href="/contact">More Contact</a></center>
